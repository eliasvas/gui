...
#define dll_push_back_NP(f,l,n,next,prev) (((f)==0)?((f)=(l)=(n),(n)->next=(n)->prev=0):((n)->prev=(l),(l)->next=(n),(l)=(n),((n)->next=0)))
#define dll_push_back(f,l,n) dll_push_back_NP(f,l,n,next,prev)
#define dll_push_front(f,l,n) dll_push_back_NP(l,f,n,prev,next)
#define dll_remove_NP(f,l,n,next,prev) (((f)==(n))?((f)=(f)->next,(f)->prev=0):(((l)==(n))?((l)=(l)->prev,(l)->next=0):((n)->next->prev=(n)->prev,(n)->prev->next=(n)->next)))
